...
type GreetClient interface {
	Hello(ctx context.Context, in *StreamReqData, opts ...grpc.CallOption) (*StreamResData, error)
	Bye(ctx context.Context, in *StreamReqData, opts ...grpc.CallOption) (*StreamResData, error)
}
...
func (c *greetClient) Hello(ctx context.Context, in *StreamReqData, opts ...grpc.CallOption) (*StreamResData, error) {
	out := new(StreamResData)
...
func (c *greetClient) Bye(ctx context.Context, in *StreamReqData, opts ...grpc.CallOption) (*StreamResData, error) {
	out := new(StreamResData)
	err := c.cc.Invoke(ctx, "/proto.Greet/Bye", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetServer interface {
	Hello(context.Context, *StreamReqData) (*StreamResData, error)
	Bye(context.Context, *StreamReqData) (*StreamResData, error)
...
func (UnimplementedGreetServer) Hello(context.Context, *StreamReqData) (*StreamResData, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Hello not implemented")
}
func (UnimplementedGreetServer) Bye(context.Context, *StreamReqData) (*StreamResData, error) {
...
func _Greet_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServer).Hello(ctx, req.(*StreamReqData))
	}
	return interceptor(ctx, in, info, handler)
}

func _Greet_Bye_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StreamReqData)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServer).Bye(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Greet/Bye",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServer).Bye(ctx, req.(*StreamReqData))
	}
	return interceptor(ctx, in, info, handler)
}
