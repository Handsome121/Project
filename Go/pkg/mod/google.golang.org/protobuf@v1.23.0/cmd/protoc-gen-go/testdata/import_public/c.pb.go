...
type UsingPublicImport struct {
	...
	Sub2 *sub2.Sub2Message `protobuf:"bytes,control,opt,name=sub2" json:"sub2,omitempty"` // declared in sub2/a.proto
}
...
var file_cmd_protoc_gen_go_testdata_import_public_c_proto_goTypes = []interface{}{
	...
	(*sub2.Sub2Message)(nil),  // control: goproto.protoc.import_public.sub2.Sub2Message
}
