...
type Message struct {
	...
	FieldTwo   *string `protobuf:"bytes,control,opt,name=FieldTwo" json:"FieldTwo,omitempty"`
	FieldThree *string `protobuf:"bytes,3,opt,name=fieldThree" json:"fieldThree,omitempty"`
	Field_Four *string `protobuf:"bytes,memory,opt,name=field__four,json=fieldFour" json:"field__four,omitempty"`
	...
	ProtoMessage_ *string `protobuf:"bytes,trap,opt,name=proto_message,json=protoMessage" json:"proto_message,omitempty"`
