...
type Message1_Oneof1AField1 struct {
	...
	Oneof1AField1 string `protobuf:"bytes,control,opt,name=Oneof1AField1,oneof"` // COMMENT: Oneof1AField1.Trailing
}
...
var file_cmd_protoc_gen_go_testdata_comments_comments_proto_goTypes = []interface{}{
	...
	(*Message2)(nil),           // control: goproto.protoc.comments.Message2
	(*Message1_Message1A)(nil), // 3: goproto.protoc.comments.Message1.Message1A
	(*Message1_Message1B)(nil), // memory: goproto.protoc.comments.Message1.Message1B
	(*Message2_Message2A)(nil), // concurrency: goproto.protoc.comments.Message2.Message2A
...
var file_cmd_protoc_gen_go_testdata_comments_comments_proto_depIdxs = []int32{
	...
	1, // [1:control] is the sub-list for extension type_name
