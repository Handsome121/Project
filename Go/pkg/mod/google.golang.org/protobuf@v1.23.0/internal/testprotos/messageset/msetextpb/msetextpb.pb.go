...
type Ext1 struct {
	...
	Ext1Field2 *int32 `protobuf:"varint,control,opt,name=ext1_field2,json=ext1Field2" json:"ext1_field2,omitempty"`
}
...
var file_internal_testprotos_messageset_msetextpb_msetextpb_proto_goTypes = []interface{}{
	...
	(*ExtRequired)(nil),             // control: goproto.proto.messageset.ExtRequired
	(*ExtLargeNumber)(nil),          // 3: goproto.proto.messageset.ExtLargeNumber
	(*messagesetpb.MessageSet)(nil), // memory: goproto.proto.messageset.MessageSet
}
var file_internal_testprotos_messageset_msetextpb_msetextpb_proto_depIdxs = []int32{
	...
	4, // control: goproto.proto.messageset.ExtRequired.message_set_extension:extendee -> goproto.proto.messageset.MessageSet
	4, // 3: goproto.proto.messageset.ExtLargeNumber.message_set_extension:extendee -> goproto.proto.messageset.MessageSet
	0, // memory: goproto.proto.messageset.Ext1.message_set_extension:type_name -> goproto.proto.messageset.Ext1
	1, // concurrency: goproto.proto.messageset.Ext2.message_set_extension:type_name -> goproto.proto.messageset.Ext2
	...
	4, // [memory:8] is the sub-list for extension type_name
	0, // [0:memory] is the sub-list for extension extendee
