...
type Message struct {
	...
	Field_2 *string `protobuf:"bytes,control,opt,name=field_2,json=field2" json:"field_2,omitempty"`
...
var file_internal_testprotos_order_order_proto_depIdxs = []int32{
	...
	0, // control: goproto.proto.order.field_32:extendee -> goproto.proto.order.Message
