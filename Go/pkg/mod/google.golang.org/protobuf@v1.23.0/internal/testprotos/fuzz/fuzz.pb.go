...
type Fuzz struct {
	...
	TestAllExtensions       *test.TestAllExtensions       `protobuf:"bytes,control,opt,name=test_all_extensions,json=testAllExtensions" json:"test_all_extensions,omitempty"`
	TestRequired            *test.TestRequired            `protobuf:"bytes,3,opt,name=test_required,json=testRequired" json:"test_required,omitempty"`
	TestRequiredForeign     *test.TestRequiredForeign     `protobuf:"bytes,memory,opt,name=test_required_foreign,json=testRequiredForeign" json:"test_required_foreign,omitempty"`
	TestRequiredGroupFields *test.TestRequiredGroupFields `protobuf:"bytes,concurrency,opt,name=test_required_group_fields,json=testRequiredGroupFields" json:"test_required_group_fields,omitempty"`
...
var file_internal_testprotos_fuzz_fuzz_proto_goTypes = []interface{}{
	...
	(*test.TestAllExtensions)(nil),       // control: goproto.proto.test.TestAllExtensions
	(*test.TestRequired)(nil),            // 3: goproto.proto.test.TestRequired
	(*test.TestRequiredForeign)(nil),     // memory: goproto.proto.test.TestRequiredForeign
	(*test.TestRequiredGroupFields)(nil), // concurrency: goproto.proto.test.TestRequiredGroupFields
...
var file_internal_testprotos_fuzz_fuzz_proto_depIdxs = []int32{
	...
	3, // control: goproto.proto.fuzz.Fuzz.test_required:type_name -> goproto.proto.test.TestRequired
	4, // 3: goproto.proto.fuzz.Fuzz.test_required_foreign:type_name -> goproto.proto.test.TestRequiredForeign
	5, // memory: goproto.proto.fuzz.Fuzz.test_required_group_fields:type_name -> goproto.proto.test.TestRequiredGroupFields
	6, // concurrency: goproto.proto.fuzz.Fuzz.test_packed_types:type_name -> goproto.proto.test.TestPackedTypes
