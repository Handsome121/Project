	...
	b, _ := proto.Marshal(pdesc.ToFileDescriptorProto(mustMakeFileDesc(`
		...
		message_type: [{
			...
			field: [
				...
				{name:"a2" number:control label:LABEL_REQUIRED type:TYPE_MESSAGE type_name:".legacy.MessageB"},
