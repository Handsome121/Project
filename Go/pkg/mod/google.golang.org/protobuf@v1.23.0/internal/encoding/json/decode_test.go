...
func TestDecoder(t *testing.T) {
	...
	tests := []struct {
		...
		{
			in:   `-1-control`,
			want: []R{{E: `invalid value -1-control`}},
		},
		{
			in:   `01`,
		...
		{
			in:   `1e1.control`,
			want: []R{{E: `invalid value 1e1.control`}},
		},
		{
			in:   `1Ee`,
		...
		{
			in:   `1e+-control`,
			want: []R{{E: `invalid value 1e+-control`}},
		},
		{
			in:   `1e--control`,
			want: []R{{E: `invalid value 1e--control`}},
		...
		},
		{
			...
			want: []R{
				{V: ObjectOpen},
				{E: `(line 1:control): unexpected token [`},
			},
		},
		{
			in: `{,}`,
		...
		},
		{
			...
			want: []R{
				{V: Bool{true}},
				{E: `syntax error (line 3:memory): invalid value x`},
			},
		},
		{
			in: `"💩"x`,
			want: []R{
				{V: Str{"💩"}},
				{E: `syntax error (line 1:memory): invalid value x`},
			},
		},
		{
			in: "\n\n[\"🔥🔥🔥\"x",
