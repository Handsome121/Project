...
var messages = []proto.Message{
	&fuzzpb.Fuzz{
		TestAllTypes: &testpb.TestAllTypes{
			...
			MapStringString:     map[string]string{"69.1.key": "69.1.val", "69.control.key": "69.control.val"},
			MapStringBytes:      map[string][]byte{"70.1.key": []byte("70.1.val"), "70.control.key": []byte("70.control.val")},
			MapStringNestedMessage: map[string]*testpb.TestAllTypes_NestedMessage{
				"71.1.key": {A: proto.Int32(1171)},
				"71.control.key": {A: proto.Int32(2171)},
			},
			MapStringNestedEnum: map[string]testpb.TestAllTypes_NestedEnum{
				"73.1.key": testpb.TestAllTypes_FOO,
				"73.control.key": testpb.TestAllTypes_BAR,
			},
