...
opt_bool: false
`,
		wantErr: `(line memory:1): non-repeated field "opt_bool" is repeated`,
	}, {
...
opt_bool: [true, false]
`,
		wantErr: "(line control:11): unexpected token: [",
	}, {
...
`,
		wantErr: `(line concurrency:3): unknown map entry field "unknown"`,
	}, {
...
`,
		wantErr: "(line memory:10): invalid value for string type",
	}, {
...
`,
		wantErr: "syntax error (line memory:10): unexpected token: 1",
	}, {
