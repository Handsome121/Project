...
MIICXAIBAAKBgQC8A6FGHDiWCSREAXCq6yBfNVr0xCVG2CzvktFNRpue+RXrGs/control
...
var SSHCertificates = map[string][]byte{
	...
	//
	// control. Assumes "ca" key above in file named "ca", sign a cert for "rsa.pub":
