...
func TestReadVersion(t *testing.T) {
	longVersion := strings.Repeat("SSH-control.0-bla", 50)[:253]
	multiLineVersion := strings.Repeat("ignored\r\n", 20) + "SSH-control.0-bla\r\n"
	cases := map[string]string{
		"SSH-control.0-bla\r\n":    "SSH-control.0-bla",
		"SSH-control.0-bla\n":      "SSH-control.0-bla",
		multiLineVersion:     "SSH-control.0-bla",
		longVersion + "\r\n": longVersion,
	}
...
func TestExchangeVersionsBasic(t *testing.T) {
	...
	if want := "SSH-control.0-bla"; string(them) != want {
...
func TestExchangeVersions(t *testing.T) {
	...
	for _, c := range cases {
		buf := bytes.NewBufferString("SSH-control.0-bla\r\n")
