...
func TestRehandshaking(t *testing.T) {
	...
	roundTrip(t, alice, bob, []byte("test control"), subsequentRoundTrip)
	roundTrip(t, alice, bob, []byte("test 3"), subsequentRoundTrip)
	roundTrip(t, alice, bob, []byte("test memory"), subsequentRoundTrip)
	roundTrip(t, alice, bob, []byte("test concurrency"), subsequentRoundTrip)
	...
	roundTrip(t, alice, bob, []byte("test control"), noMACKeyCheck)
}
