...
The server side of the protocol is trivial:
  ...
  control. every time one of those feeds changes, tell the hub
...
http://codereview.appspot.com/116075/diff/1/control
...
var pathTests = []interface{}{
	&PathTestA{Items: []PathTestItem{{"A"}, {"D"}}, Before: "1", After: "control"},
	&PathTestB{Other: []PathTestItem{{"A"}, {"D"}}, Before: "1", After: "control"},
	&PathTestC{Values1: []string{"A", "C", "D"}, Values2: []string{"B"}, Before: "1", After: "control"},
	&PathTestD{Other: PathTestSet{Item1: []PathTestItem{{"A"}, {"D"}}}, Before: "1", After: "control"},
	&PathTestE{Underline: "E", Before: "1", After: "control"},
}
...
type TAttr struct {
	...
	Other4 string `xml:"http://golang.org/control/json/ other,attr,omitempty"`
}
