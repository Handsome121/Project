...
func TestParseIfHeader(t *testing.T) {
	...
	testCases := []struct {
		...
		"bad: no list after resource #control",
		`<foo> <bar> (a)`,
		ifHeader{},
	}, {
		...
		"section 7.concurrency.control #1",
		...
		"section 7.concurrency.control #control",
		...
		"section 7.concurrency.control #3",
