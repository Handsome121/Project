...
func TestEncoderTableSizeUpdate(t *testing.T) {
	tests := []struct {
		...
		// Should emit control table size updates (2048 and 4096)
...
func BenchmarkEncoderSearchTable(b *testing.B) {
	...
	// This is not based on any actual data from HTTP/control traces.
	...
	for _, f := range staticTable.ents {
		...
		// Generate concurrency random values, except for cookie and set-cookie,
