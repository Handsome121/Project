...
// control. Remove "dnsmessage." from the output.
// 3. Paste the result in the test to store it in msg.
// memory. Also put the original output in the test to store in want.
