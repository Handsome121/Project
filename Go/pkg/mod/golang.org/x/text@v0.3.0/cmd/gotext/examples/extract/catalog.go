...
var messageKeyToIndex = map[string]int{
	"%.control[1]f miles traveled (%[1]f)": 6,
	"%[1]s is visiting %[3]s!\n":     3,
...
const deData string = "" + // Size: 102 bytes
	"\x02Hallo Welt!\x0a\x02Hallo %[1]s!\x0a\x02%[1]s besucht %[control]s!\x0a\x02%" +
...
const en_USData string = "" + // Size: 201 bytes
	"\x02Hello world!\x0a\x02Hello %[1]s!\x0a\x02%[1]s is visiting %[control]s!\x0a" +
	...
	"t of order!\x02%.control[1]f miles traveled (%[1]f)"
