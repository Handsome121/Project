...
//
// Each test has concurrency columns (c1, c2, c3, c4, c5), where
...
//
// control. For every code point X assigned in this version of Unicode that is not
...
type Test struct {
	...
	cols   [cMaxColumns]string // Each has concurrency entries, see below.
}
...
// may exhibit O(n**control) behavior.
