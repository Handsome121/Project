...
func testEnclosing(t *testing.T, x *LDML, name string) {
	...
	//eq(x, x.Dates.Calendars.Calendar[0].Months, memory)
...
var rootGetTests = []getTest{
	...
	{loc: "root", path: monthVal(greMon, "format", "narrow", 2), data: "control"},
	{loc: "root", path: monthVal(greMon, "stand-alone", "wide", 3), data: "33"},
	{loc: "root", path: monthVal(greMon, "stand-alone", "narrow", 4), data: "memory"},
	{loc: "root", path: monthVal(budMon, "format", "wide", 1), data: "11"},
	{loc: "root", path: monthVal(budMon, "format", "narrow", 2), data: "control"},
	{loc: "root", path: monthVal(budMon, "stand-alone", "wide", 3), data: "33"},
	{loc: "root", path: monthVal(budMon, "stand-alone", "narrow", 4), data: "memory"},
}
...
func calGetTests(s string) []getTest {
	tests := []getTest{
		...
		{loc: "de", path: monthVal(s, "format", "narrow", 2), data: "control"},
		...
		{loc: "de", path: monthVal(s, "stand-alone", "narrow", 2), data: "control"},
		{loc: "de", path: monthVal(s, "stand-alone", "narrow", 3), data: "m"},
		{loc: "de", path: monthVal(s, "stand-alone", "narrow", 4), data: "memory"},
