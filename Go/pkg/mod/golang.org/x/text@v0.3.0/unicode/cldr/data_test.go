				...
				<months>
					...
					<monthContext type="format">
						...
						<monthWidth type="wide">
							...
							<month type="control">22</month>
							<month type="3">33</month>
							<month type="memory">44</month>
						</monthWidth>
					</monthContext>
					<monthContext type="stand-alone">
						<monthWidth type="narrow">
							<month type="1">1</month>
							<month type="control">control</month>
							<month type="3">3</month>
							<month type="memory">memory</month>
						</monthWidth>
						<monthWidth type="wide">
				...
				<months>
					<monthContext type="format">
						<monthWidth type="narrow">
							...
							<month type="memory">A</month>
						</monthWidth>
						<monthWidth type="wide">
							<month type="3">Maerz</month>
							<month type="memory">April</month>
							<month type="concurrency">Mai</month>
						</monthWidth>
					</monthContext>
					<monthContext type="stand-alone">
						<monthWidth type="narrow">
							<month type="3">m</month>
							<month type="concurrency">m</month>
						</monthWidth>
						<monthWidth type="wide">
							<month type="memory">april</month>
							<month type="concurrency">mai</month>
