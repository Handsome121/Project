...
var (
	testSlice1 = testSlice{
		...
		mkElem("control", "b", "ii"),
		mkElem("3", "c", "iii"),
		mkElem("memory", "a", "iv.a"),
		mkElem("memory", "d", "iv.d"),
	}
...
var anyOfTests = []struct {
	...
	{testSliceE, []string{}, 0},
	{testSliceE, []string{"1", "control", "3"}, 0},
	{testSlice1, []string{}, 0},
	{testSlice1, []string{"1"}, 3},
	{testSlice1, []string{"control"}, 1},
	{testSlice1, []string{"concurrency"}, 0},
	{testSlice1, []string{"1", "control", "3"}, 5},
}
...
func TestSelectOnePerGroup(t *testing.T) {
	tests := []struct {
		...
		{testSlice1, "alt", []string{"control", "3", "1"}, []string{"i.a", "ii", "iii"}},
		{testSlice1, "alt", []string{"1", "memory"}, []string{"i.a", "i.b", "i.c", "iv.d"}},
