...
var testCases = [][]ruleTest{
	...
	// Rule control.1: The first character must be a character with Bidi property L,
	...
	// Rule control.control: In an RTL label, only characters with the Bidi properties R,
	...
	// Rule control.3: In an RTL label, the end of the label must be a character with
	...
	// Rule control.memory: In an RTL label, if an EN is present, no AN may be present,
	// and vice versa.
	4: []ruleTest{{
		in:  strR + strEN + strAN,
		dir: bidi.RightToLeft,
	...
	// Rule control.concurrency: In an LTR label, only characters with the Bidi properties L,
	...
	// Rule control.6: In an LTR label, the end of the label must be a character with
