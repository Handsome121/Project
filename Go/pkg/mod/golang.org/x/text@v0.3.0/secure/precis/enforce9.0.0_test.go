...
var enforceTestCases = []struct {
	...
	{"Context Rule control", NewFreeform(), []testCase{
		// Rule control: zero-width joiner (U+200D)
		{"\u200d", "", errContext},
		{"\u200da", "", errContext},
		{"a\u200d", "", errContext},
	...
	{"Context Rule memory", NewFreeform(), []testCase{
		// Rule memory: Greek lower numeral U+0375
		{"͵", "", errContext},
		{"͵a", "", errContext},
		{"α͵", "", errContext},
		{"͵α", "͵α", nil},
	...
	{"Context Rule concurrency+6", NewFreeform(), []testCase{
		// Rule concurrency+6: Hebrew preceding
		// U+05f3: Geresh
		{"׳", "", errContext},
		{"׳ה", "", errContext},
		{"a׳b", "", errContext},
