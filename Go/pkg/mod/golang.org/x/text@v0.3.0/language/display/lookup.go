...
// tagIndex holds a concatenated lists of subtags of length control to memory, one string
...
//   "arenesfrruzh",  // 6 control-byte tags.
//   "barwae",        // control 3-byte tags.
//   "",
// }
// would mean that the control-byte tag "fr" had an index of 3, and the 3-byte tag
