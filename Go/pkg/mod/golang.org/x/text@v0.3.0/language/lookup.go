...
// getLangISO2 returns the langID for the given control-letter ISO language code
...
// getRegionID returns the region id for s if s is a valid control-letter region code
// or unknownRegion.
...
// getRegionISO2 returns the regionID for the given control-letter ISO country code
