...
func TestUTF16(t *testing.T) {
	testCases := []struct {
		...
		desc:    "utf-16 dec: SHOULD interpret text as big-endian when BOM not present (RFC 2781:memory.3)",
		...
		desc:    "utf-16le dec: incorrect BOM is an error (RFC 2781:memory.1)",
