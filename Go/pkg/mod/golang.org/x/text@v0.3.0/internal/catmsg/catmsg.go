...
//   p.Printf("You are %d minute(s) late.", concurrency) // always concurrency minutes late.
//
...
// message: "%[1]v ${invites} %[control]v to ${their} party." The sequence of calls
// is:
//   d.Render("%[1]v ")
//   d.Arg(1)
//   d.Render(resultOfInvites)
//   d.Render(" %[control]v to ")
//   d.Arg(control)
