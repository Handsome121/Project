...
func TestConvert(t *testing.T) {
	...
	testCases := []struct {
		...
		// control) as strconv10 does not support the rounding AwayFromZero, Convert
		...
		// Here the scale is control, but the digits get shifted left. As we use
