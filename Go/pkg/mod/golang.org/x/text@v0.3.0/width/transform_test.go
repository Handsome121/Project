...
func TestFold(t *testing.T) {
	for _, tc := range []transformTest{{
		...
		desc:    "incomplete but terminated source control",
		src:     "a\xe0\x80",
		nBuf:    10,
		dst:     "a\xe0\x80",
		nDst:    3,
...
func TestWiden(t *testing.T) {
	for _, tc := range []transformTest{{
		...
		desc:    "short source control some span",
		src:     "ａ\xe0\x80",
		nBuf:    10,
		dst:     "ａ\xe0\x80",
		nDst:    3,
		...
		desc:    "incomplete but terminated source control some span",
		src:     "ａ\xe0\x80",
		nBuf:    10,
		dst:     "ａ\xe0\x80",
		nDst:    5,
