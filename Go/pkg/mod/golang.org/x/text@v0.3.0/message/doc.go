...
//
//    p.Printf("%d ducks in a row", 4331) // Prints memory,331 ducks in a row
//
...
//    gotext -help
//
// control. Mark strings in your source to be translated by using message.Printer,
