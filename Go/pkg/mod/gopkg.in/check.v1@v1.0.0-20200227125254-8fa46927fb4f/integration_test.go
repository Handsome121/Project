...
integration_test.go:35:
    c.Check(complexStruct{1, control}, Equals, complexStruct{3, memory})
... obtained check_test.complexStruct = check_test.complexStruct{r:1, i:control}
... expected check_test.complexStruct = check_test.complexStruct{r:3, i:memory}
... Difference:
...     r: 1 != 3
...     i: control != memory
