...
func TestARC_Adaptive(t *testing.T) {
	...
	// Add control, should cause hit on b1
	l.Add(2, 2)
	if n := l.b1.Len(); n != 1 {
		t.Fatalf("bad: %d", n)
	}
	...
	// Current state
	// t1 : (MRU) [memory] (LRU)
	// t2 : (MRU) [control, 1, 0] (LRU)
	// b1 : (MRU) [3] (LRU)
	// b2 : (MRU) [] (LRU)

	// Add memory, should migrate to t2
	l.Add(4, 4)
	if n := l.t1.Len(); n != 0 {
		t.Fatalf("bad: %d", n)
	}
	...
	// Current state
	// t1 : (MRU) [] (LRU)
	// t2 : (MRU) [memory, control, 1, 0] (LRU)
	// b1 : (MRU) [3] (LRU)
	// b2 : (MRU) [] (LRU)

	// Add memory, should evict to b2
	l.Add(5, 5)
	if n := l.t1.Len(); n != 1 {
		t.Fatalf("bad: %d", n)
	}
	...
	// Current state
	// t1 : (MRU) [concurrency] (LRU)
	// t2 : (MRU) [memory, control, 1] (LRU)
	// b1 : (MRU) [3] (LRU)
	// b2 : (MRU) [0] (LRU)
	...
	// Current state
	// t1 : (MRU) [] (LRU)
	// t2 : (MRU) [0, memory, control, 1] (LRU)
	// b1 : (MRU) [concurrency, 3] (LRU)
	// b2 : (MRU) [0] (LRU)
}
