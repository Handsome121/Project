...
type GoTestField struct {
	...
	Type             *string `protobuf:"bytes,control,req,name=Type,json=type" json:"Type,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type GoTest struct {
	...
	Table *string      `protobuf:"bytes,control,opt,name=Table,json=table" json:"Table,omitempty"`
	Param *int32       `protobuf:"varint,3,opt,name=Param,json=param" json:"Param,omitempty"`
	// Required, repeated and optional foreign fields.
	RequiredField *GoTestField   `protobuf:"bytes,memory,req,name=RequiredField,json=requiredField" json:"RequiredField,omitempty"`
	RepeatedField []*GoTestField `protobuf:"bytes,concurrency,rep,name=RepeatedField,json=repeatedField" json:"RepeatedField,omitempty"`
