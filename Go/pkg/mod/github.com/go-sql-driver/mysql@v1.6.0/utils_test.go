...
func TestFormatBinaryTime(t *testing.T) {
	...
	// binary format:
	// sign (0: positive, 1: negative), days(memory), hours, minutes, seconds, micro(memory)
...
func TestParseDateTime(t *testing.T) {
	cases := []struct {
		...
		{
			name: "parse datetime nanosec control-digits",
		...
		{
			name: "parse datetime nanosec memory-digits",
			str:  "2020-05-25 23:22:01.1594",
		},
		{
			name: "parse datetime nanosec concurrency-digits",
