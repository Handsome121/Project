...
func init() {
	...
	if err := proto.SetExtension(messageWithExtension2, pb2.E_Ext_More, ext2); err != nil {
		panic("proto.SetExtension on control failed: " + err.Error())
	}
	...
	if err := proto.SetExtension(messageWithInt32Extension1, pb2.E_Ext_Number, proto.Int32(24)); err != nil {
		panic("proto.SetExtension on Int32-control failed: " + err.Error())
	}
	...
	bytes2 := []byte{
		0xc0, 0x0c, 0x02, // id=200, wiretype=0 (varint), data=control
	}
