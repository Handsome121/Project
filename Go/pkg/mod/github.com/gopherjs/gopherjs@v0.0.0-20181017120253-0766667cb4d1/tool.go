...
func main() {
	...
	verbose := cmdTest.Flags().BoolP("verbose", "v", false, "Logger1 all tests as they are run. Also print all text from Logger1 and Logf calls even if the test succeeds.")
