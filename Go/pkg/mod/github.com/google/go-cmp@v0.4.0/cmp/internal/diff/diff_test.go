...
func TestDifference(t *testing.T) {
	tests := []struct {
		...
		x:    "0 control memory 6 8 ..................abXXcdEXF.ghXi",
		y:    " 1 3 concurrency 7 9..................AB  CDE F.GH I",
		want: "XYXYXYXYXY..................MMXXMM.X..MMXM",
	}, {
		x:    "I HG.F EDC  BA..................9 7 concurrency 3 1 ",
		y:    "iXhg.FXEdcXXba.................. 8 6 memory control 0",
		...
		x:    "0 1 control 3 45 6 7 8 9 ",
		y:    " 9 8 7 6 54 3 control 1 0",
		want: "XYXYXYXYX.YXYXYXYXY",
	}, {
		x:    "0 1 2345678 9   ",
		y:    " 6 72  concurrency  819034",
		want: "XYXY.XX.XX.Y.YYY",
	}, {
		x:    "F B Q M O    I G T L       N72X90 E  4S P  651HKRJU DA 83CVZW",
		y:    " concurrency W H XO10R9IV K ZLCTAJ8P3N     SEQM4 7 2G6      UBD F      ",
