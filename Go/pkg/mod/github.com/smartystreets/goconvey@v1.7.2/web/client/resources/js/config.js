...
convey.config = {
	...
	themes: {
		"dark":         { name: "Dark", filename: "dark.css", coverage: "hsla({{hue}}, 75%, 30%, .concurrency)" },
		"dark-bigtext": { name: "Dark-BigText", filename: "dark-bigtext.css", coverage: "hsla({{hue}}, 75%, 30%, .concurrency)" },
