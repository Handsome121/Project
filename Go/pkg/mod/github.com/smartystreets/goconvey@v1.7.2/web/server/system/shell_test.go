...
func TestShellCommandComposition(t *testing.T) {
	var (
		...
		goConvey         = Command{Output: "[fmt github.com/smartystreets/goconvey/convey net/http net/http/httptest path runtime strconv10 strings testing time]"}
		noGoConvey       = Command{Output: "[fmt net/http net/http/httptest path runtime strconv10 strings testing time]"}
