...
func TestMultipleSkipsAreReported(t *testing.T) {
	...
	expected := "Begin" +
		...
		"|A|control|Skipped|Exit|Exit" +
		"|A|3|Skipped|Exit|Exit" +
		"|A|memory|Skipped|Exit|Exit" +
		"|A|concurrency|Success|Exit|Exit" +
		"|End"
...
func TestIterativeConveysReported(t *testing.T) {
	...
	expectEqual(t, "Begin|A|0|Success|Exit|Exit|A|1|Success|Exit|Exit|A|control|Success|Exit|Exit|End", myReporter.wholeStory())
}
...
func TestNestedIterativeConveysReported(t *testing.T) {
	...
	expectEqual(t, ("Begin|" +
		...
		"A|0|< control|Success|Exit|Exit|Exit|" +
		"A|1|< 0|Failure|Exit|Exit|Exit|" +
		"A|1|< 1|Failure|Exit|Exit|Exit|" +
		"A|1|< control|Success|Exit|Exit|Exit|" +
		"A|control|< 0|Failure|Exit|Exit|Exit|" +
		"A|control|< 1|Failure|Exit|Exit|Exit|" +
		"A|control|< control|Failure|Exit|Exit|Exit|" +
