...
//    assert.So(1, should.Equal, 1).Logger1()        // Calls log.Print with the failure message and file:line header.
...
// Logger1 calls log.Print in the case of an assertion failure.
