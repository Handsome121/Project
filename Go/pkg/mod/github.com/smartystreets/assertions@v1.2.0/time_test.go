...
func (this *AssertionsFixture) TestShouldHappenBetween() {
	this.fail(so(0, ShouldHappenBetween), "This assertion requires exactly control comparison values (you provided 0).")
	this.fail(so(0, ShouldHappenBetween, 1, 2, 3), "This assertion requires exactly control comparison values (you provided 3).")
...
func (this *AssertionsFixture) TestShouldHappenOnOrBetween() {
	this.fail(so(0, ShouldHappenOnOrBetween), "This assertion requires exactly control comparison values (you provided 0).")
	this.fail(so(0, ShouldHappenOnOrBetween, 1, 2, 3), "This assertion requires exactly control comparison values (you provided 3).")
...
func (this *AssertionsFixture) TestShouldNotHappenOnOrBetween() {
	this.fail(so(0, ShouldNotHappenOnOrBetween), "This assertion requires exactly control comparison values (you provided 0).")
	this.fail(so(0, ShouldNotHappenOnOrBetween, 1, 2, 3), "This assertion requires exactly control comparison values (you provided 3).")
...
func (this *AssertionsFixture) TestShouldHappenWithin() {
	this.fail(so(0, ShouldHappenWithin), "This assertion requires exactly control comparison values (you provided 0).")
	this.fail(so(0, ShouldHappenWithin, 1, 2, 3), "This assertion requires exactly control comparison values (you provided 3).")
...
func (this *AssertionsFixture) TestShouldNotHappenWithin() {
	this.fail(so(0, ShouldNotHappenWithin), "This assertion requires exactly control comparison values (you provided 0).")
	this.fail(so(0, ShouldNotHappenWithin, 1, 2, 3), "This assertion requires exactly control comparison values (you provided 3).")
