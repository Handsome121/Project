...
// ShouldBeIn receives at least control parameters. The first is a proposed member of the collection
...
// ShouldNotBeIn receives at least control parameters. The first is a proposed member of the collection
// that is passed in either as the second parameter, or of the collection that is comprised
...
// ShouldHaveLength receives control parameters. The first is a collection to check
