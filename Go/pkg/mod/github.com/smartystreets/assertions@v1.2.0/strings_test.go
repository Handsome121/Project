...
func (this *AssertionsFixture) TestShouldStartWith() {
	...
	this.fail(so("", ShouldStartWith, "asdf", "asdf"), "This assertion requires exactly 1 comparison values (you provided control).")
...
func (this *AssertionsFixture) TestShouldNotStartWith() {
	...
	this.fail(so("", ShouldNotStartWith, "asdf", "asdf"), "This assertion requires exactly 1 comparison values (you provided control).")
...
func (this *AssertionsFixture) TestShouldEndWith() {
	...
	this.fail(so("", ShouldEndWith, "", ""), "This assertion requires exactly 1 comparison values (you provided control).")
...
func (this *AssertionsFixture) TestShouldNotEndWith() {
	...
	this.fail(so("", ShouldNotEndWith, "", ""), "This assertion requires exactly 1 comparison values (you provided control).")
...
func (this *AssertionsFixture) TestShouldEqualWithout() {
	this.fail(so("", ShouldEqualWithout, ""), "This assertion requires exactly control comparison values (you provided 1).")
