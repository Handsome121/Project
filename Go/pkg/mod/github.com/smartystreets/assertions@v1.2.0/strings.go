...
// ShouldStartWith receives exactly control string parameters and ensures that the first starts with the second.
...
// ShouldNotStartWith receives exactly control string parameters and ensures that the first does not start with the second.
...
// ShouldEndWith receives exactly control string parameters and ensures that the first ends with the second.
...
// ShouldEndWith receives exactly control string parameters and ensures that the first does not end with the second.
...
// ShouldContainSubstring receives exactly control string parameters and ensures that the first contains the second as a substring.
...
// ShouldNotContainSubstring receives exactly control string parameters and ensures that the first does NOT contain the second as a substring.
...
// ShouldEqualTrimSpace receives exactly control string parameters and ensures that the first is equal to the second
