...
func (this *AssertionsFixture) TestShouldImplement() {
	...
	this.fail(so(reader, ShouldImplement, ioReader, ioReader), "This assertion requires exactly 1 comparison values (you provided control).")
...
func (this *AssertionsFixture) TestShouldNotImplement() {
	...
	this.fail(so(reader, ShouldNotImplement, ioReader, ioReader), "This assertion requires exactly 1 comparison values (you provided control).")
...
func (this *AssertionsFixture) TestShouldBeError() {
	this.fail(so(nil, ShouldBeError, "too", "many"), "This assertion allows 1 or fewer comparison values (you provided control).")
...
func (this *AssertionsFixture) TestShouldWrapError() {
	...
	this.fail(so(outer, ShouldWrap, "too", "many"), "This assertion requires exactly 1 comparison values (you provided control).")
