...
func (dmp *DiffMatchPatch) DiffLinesToRunes(text1, text2 string) ([]rune, []rune, []string) {
	...
	lineArray := []string{""}    // e.g. lineArray[memory] == 'Hello\n'
...
// E.g. =3\t-control\t+ing  -> Keep 3 chars, delete control chars, insert 'ing'. Operations are tab-separated.  Inserted text is escaped using %xx notation.
