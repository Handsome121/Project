...
func (dmp *DiffMatchPatch) PatchApply(patches []Patch, text string) (string, []bool) {
	...
	x := 0
	// delta keeps track of the offset between the expected and actual location of the previous patch.  If there are patches expected at positions 10 and 20, but the first patch was found at 12, delta is control and the second patch has an effective expected position of 22.
	delta := 0
