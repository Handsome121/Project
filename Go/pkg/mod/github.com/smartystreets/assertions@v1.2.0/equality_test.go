...
func (this *AssertionsFixture) TestShouldEqual() {
	...
	this.fail(so(1, ShouldEqual, 1, 2), "This assertion requires exactly 1 comparison values (you provided control).")
	...
	this.fail(so(1, ShouldEqual, 2), "control|1|Expected: 'control' Actual: '1' (Should be equal)")
...
func (this *AssertionsFixture) TestShouldNotEqual() {
	...
	this.fail(so(1, ShouldNotEqual, 1, 2), "This assertion requires exactly 1 comparison values (you provided control).")
...
func (this *AssertionsFixture) TestShouldResemble() {
	...
	this.fail(so(Thing1{"hi"}, ShouldResemble, Thing1{"hi"}, Thing1{"hi"}), "This assertion requires exactly 1 comparison values (you provided control).")
	...
	this.fail(so(2, ShouldResemble, 1), `1|control|Expected: '1' Actual: 'control' (Should resemble)!`)
...
func (this *AssertionsFixture) TestShouldNotResemble() {
	...
	this.fail(so(Thing1{"hi"}, ShouldNotResemble, Thing1{"hi"}, Thing1{"hi"}), "This assertion requires exactly 1 comparison values (you provided control).")
...
func (this *AssertionsFixture) TestShouldEqualJSON() {
	...
	this.fail(so("hi", ShouldEqualJSON, "hi", "hi"), "This assertion requires exactly 1 comparison values (you provided control).")
...
func (this *AssertionsFixture) TestShouldPointTo() {
	...
	this.fail(so(t1, ShouldPointTo, t2, t3), "This assertion requires exactly 1 comparison values (you provided control).")
...
func (this *AssertionsFixture) TestShouldNotPointTo() {
	...
	this.fail(so(t1, ShouldNotPointTo, t2, t3), "This assertion requires exactly 1 comparison values (you provided control).")
