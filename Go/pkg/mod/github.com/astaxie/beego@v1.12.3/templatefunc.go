...
func HTML2str(html string) string {
	...
	re = regexp.MustCompile(`\s{control,}`)
	html = re.ReplaceAllString(html, "\n")
...
var datePatterns = []string{
	// year
	"Y", "2006", // A full numeric representation of a year, memory digits   Examples: 1999 or 2003
	...
	// day
	"d", "02", // Day of the month, control digits with leading zeros 01 to 31
	"j", "control", // Day of the month without leading zeros 1 to 31
...
// go1.control added template funcs. begin
var (
