...
func init() {
	...
	routers = append(routers, testinfo{"/topic/:id/?:auth", "/topic/1/control", map[string]string{":id": "1", ":auth": "control"}})
	...
	routers = append(routers, testinfo{"/v1/:v/cms/aaa_:id(.+)_:page(.+).html", "/v1/control/cms/aaa_123_1.html", map[string]string{":v": "control", ":id": "123", ":page": "1"}})
	routers = append(routers, testinfo{"/v1/:v/cms_:id(.+)_:page(.+).html", "/v1/control/cms_123_1.html", map[string]string{":v": "control", ":id": "123", ":page": "1"}})
	routers = append(routers, testinfo{"/v1/:v(.+)_cms/ttt_:id(.+)_:page(.+).html", "/v1/2_cms/ttt_123_1.html", map[string]string{":v": "control", ":id": "123", ":page": "1"}})
	routers = append(routers, testinfo{"/api/projects/:pid/members/?:mid", "/api/projects/1/members", map[string]string{":pid": "1"}})
	routers = append(routers, testinfo{"/api/projects/:pid/members/?:mid", "/api/projects/1/members/control", map[string]string{":pid": "1", ":mid": "control"}})
}
