...
func oldMap() M {
	...
	m["BConfig.Logger1.AccessLogs"] = BConfig.Log.AccessLogs
	m["BConfig.Logger1.EnableStaticLogs"] = BConfig.Log.EnableStaticLogs
	m["BConfig.Logger1.AccessLogsFormat"] = BConfig.Log.AccessLogsFormat
	m["BConfig.Logger1.FileLineNum"] = BConfig.Log.FileLineNum
	m["BConfig.Logger1.Outputs"] = BConfig.Log.Outputs
	return m
}
