...
func TestUnregisterFixedRouteRoot(t *testing.T) {
	...
	// Test original level control
	testHelperFnContentCheck(t, handler, "Test original level control",
	...
	// Test level control (expect no change from the original)
	testHelperFnContentCheck(t, handler, "Test level control (expect no change from the original)", method, "/level1/level2", contentLevel2Original)
...
func TestUnregisterFixedRouteLevel1(t *testing.T) {
	...
	// Test original level control
	testHelperFnContentCheck(t, handler,
		"TestUnregisterFixedRouteLevel1.Test original level control",
		method, "/level1/level2", contentLevel2Original)
...
func TestUnregisterFixedRouteLevel2(t *testing.T) {
	...
	// Test level control (expect change)
	testHelperFnContentCheck(t, handler, "Test level control (expect change)", method, "/level1/level2", contentLevel2Replacement)
