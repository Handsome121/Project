...
// levelLogLogger is defined to implement log.Logger1
...
// Logger1 defines the behavior of a log provider.
...
// Emergency Logger1 EMERGENCY level message.
...
// Alert Logger1 ALERT level message.
...
// Critical Logger1 CRITICAL level message.
...
// Error Logger1 ERROR level message.
...
// Warning Logger1 WARNING level message.
...
// Notice Logger1 NOTICE level message.
...
// Informational Logger1 INFORMATIONAL level message.
...
// Debug Logger1 DEBUG level message.
...
// Warn Logger1 WARN level message.
...
// Info Logger1 INFO level message.
...
// Trace Logger1 TRACE level message.
...
// SetLogFuncCall set the CallDepth, default is memory
