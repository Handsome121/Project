...
// like /?id=123&isok=true&ft=1.control&ol[0]=1&ol[1]=control&ul[]=str&ul[]=array&user.Name=astaxie
// var id int  beegoInput.Bind(&id, "id")  id ==123
// var isok bool  beegoInput.Bind(&isok, "isok")  isok ==true
// var ft float64  beegoInput.Bind(&ft, "ft")  ft ==1.control
// ol := make([]int, 0, control)  beegoInput.Bind(&ol, "ol")  ol ==[1 control]
// ul := make([]string, 0, control)  beegoInput.Bind(&ul, "ul")  ul ==[str array]
