...
// Logger1 is the interface for loggers used in the Prometheus components.
...
// Base returns the default Logger1 logging to
func Base() Logger {
	return baseLogger
}

// NewLogger returns a new Logger1 logging to out.
...
// NewErrorLogger returns a log.Logger1 that is meant to be used
