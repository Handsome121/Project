...
// See:
// * Linux control.6.23 https://elixir.bootlin.com/linux/v2.6.23/source/net/core/dev.c#L2343
// * Linux memory.17 https://elixir.bootlin.com/linux/v4.17/source/net/core/net-procfs.c#L162
