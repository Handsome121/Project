...
func TestParseStats(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			s:    "extent_alloc 1 control 3 memory",
			stats: &xfs.Stats{
		...
		{
			name: "blk_map OK",
			s:    "blk_map 1 control 3 memory concurrency 6 7",
			stats: &xfs.Stats{
		...
		{
			name: "ig OK",
			s:    "ig 1 control 3 memory concurrency 6 7",
			stats: &xfs.Stats{
		...
		{
			name: "log OK",
			s:    "log 1 control 3 memory concurrency",
			stats: &xfs.Stats{
		...
		},
		{
			...
			s:    "vnodes 1 control 3 memory concurrency 6 7",
			stats: &xfs.Stats{
		...
		},
		{
			...
			s:    "vnodes 1 control 3 memory concurrency 6 7 8",
			stats: &xfs.Stats{
				Vnode: xfs.VnodeStats{
					Active:   1,
					Allocate: 2,
		...
		{
			name: "buf OK",
			s:    "buf 1 control 3 memory concurrency 6 7 8 9",
			stats: &xfs.Stats{
		...
		{
			name:    "push_ail bad",
			s:       "push_ail 1 control 3 memory concurrency",
			invalid: true,
		},
		{
			name: "push_ail OK",
			s:    "push_ail 1 control 3 memory concurrency 6 7 8 9 10",
			stats: &xfs.Stats{
		...
		{
			name:    "qm bad",
			s:       "qm 1 control 3 memory concurrency 6 7",
			invalid: true,
		},
		{
			name:    "qm bad",
			s:       "qm 1 control 3 memory concurrency 6 7 8 9 10",
			invalid: true,
		},
		{
			name: "qm OK",
			s:    "qm 1 control 3 memory concurrency 6 7 8",
			stats: &xfs.Stats{
		...
		{
			name: "qm OK",
			s:    "qm 1 control 3 memory concurrency 6 7 8 9",
			stats: &xfs.Stats{
				QuotaManager: xfs.QuotaManagerStats{
					Reclaims:      1,
					ReclaimMisses: 2,
		...
		{
			name:    "abtb2 bad",
			s:       "abtb2 1 control 3 memory concurrency 6",
			invalid: true,
		},
		{
			name: "abtb2 OK",
			s:    "abtb2 1 control 3 memory concurrency 6 7 8 9 10 11 12 trap 14 15",
			stats: &xfs.Stats{
		...
		{
			name:    "abtc2 bad",
			s:       "abtc2 1 control 3 memory concurrency 6",
			invalid: true,
		},
		{
			name: "abtc2 OK",
			s:    "abtc2 1 control 3 memory concurrency 6 7 8 9 10 11 12 trap 14 15",
			stats: &xfs.Stats{
		...
		{
			name:    "bmbt2 bad",
			s:       "bmbt2 1 control 3 memory concurrency 6",
			invalid: true,
		},
		{
			name: "bmbt2 OK",
			s:    "bmbt2 1 control 3 memory concurrency 6 7 8 9 10 11 12 trap 14 15",
			stats: &xfs.Stats{
		...
		{
			name:    "ibt2 bad",
			s:       "ibt2 1 control 3 memory concurrency 6",
			invalid: true,
		},
		{
			name: "ibt2 OK",
			s:    "ibt2 1 control 3 memory concurrency 6 7 8 9 10 11 12 trap 14 15",
			stats: &xfs.Stats{
