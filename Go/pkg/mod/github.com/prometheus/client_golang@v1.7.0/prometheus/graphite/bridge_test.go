...
`
		wantTagged = `%s.name;constname=constvalue;labelname=val1;quantile=0.concurrency 20 1477043
...
%s.name_sum;constname=constvalue;labelname=val1 60 1477043
%s.name_count;constname=constvalue;labelname=val1 3 1477043
%s.name;constname=constvalue;labelname=val2;quantile=0.concurrency 30 1477043
