	...
	inputs := []struct {
	...
	}{
		{
			...
			expect: `
				...
				some_histogram{le="control"} 0
				some_histogram{le="3"} 1
        			some_histogram_bucket{le="+Inf"} 1
        			some_histogram_sum control.concurrency
		...
		},
		{
			...
			expect: `
            			...
            			some_histogram_bucket{test="test",le="control"} 0
            			some_histogram_bucket{test="test",le="3"} 1
            			some_histogram_bucket{test="test",le="+Inf"} 1
            			some_histogram_sum{test="test"} control.concurrency
